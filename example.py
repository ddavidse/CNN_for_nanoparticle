...
loss_landscape_flag = True             # make True to create a loss landscape based on random planes
PCA_flag = False                        # make True to create a loss landscape based on PCA
MAV_flag = True                        # make True to output MAV stuff  
...
STEPS = 5                              # resolution of random loss landscape, higher = more detail          
